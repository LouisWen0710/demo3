...
public class AugmentedImageFragment extends ArFragment {
  ...
  // matching.
  private static final String DEFAULT_IMAGE_NAME = "70.jpg";

  // This is a pre-created database containing the sample image.
  private static final String SAMPLE_IMAGE_DATABASE = "floor.imgdb";
  ...
  public View onCreateView(
    ...
    /*getPlaneDiscoveryController().hide();   //這行＋下面兩行，如果不取消，你就別想要打點了ㄏㄏ
